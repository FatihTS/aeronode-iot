...
export const metadata: Metadata = {
  ...
  description: "Kargu Teknoloji gizlilik politikası ve KVKK aydınlatma metni.",
};
...
const bolumler = [
  {
    ...
    icerik: (
      <p>
        Bu internet sitesi Kargu Teknoloji tarafından işletilmektedir. Site
        ...
        (&ldquo;KVKK&rdquo;) kapsamında veri sorumlusu sıfatıyla Kargu Teknoloji
        tarafından işlenir.
      </p>
    ),
  },
    ...
    icerik: (
      <>
        ...
        <p className="mt-3">
          ...
          <a href="mailto:aeronode.iot@gmail.com" className="text-amber-400 hover:underline">
      ...
      <section className="border-b border-white/10 bg-gradient-to-br from-white/[0.03] to-transparent">
        <div className="max-w-4xl mx-auto px-6 py-20">
          ...
          <p className="mt-6 text-zinc-400 text-lg leading-relaxed">
            Bu sayfa, Kargu Teknoloji olarak kişisel verilerinizi nasıl
